...
description: >-
  Create distinctive, production-grade frontend interfaces with high design quality. Use when the user
  asks to build web components, pages, or applications and the visual direction matters as much as
  the code quality. For creating HTML presentations, use frontend-slides skill instead.
---
...
- avoid cliche purple-gradient-on-white unless the product genuinely calls for it
