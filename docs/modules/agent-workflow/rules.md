...
- Keep every role teammate-ready: explicit context read, success criteria, ownership scope, avoid scope, shared contracts, conflict risks, verification expectation, handoff format, and integration notes.
- Keep the main agent accountable for handoff review, final diff review coverage, integration, final verification, and evidence reporting.
